...
#line 11 "exprinterpret.y"
typedef union YYSTYPE {
   int intconst;
   char *stringconst;
} YYSTYPE;
/* Line 191 of yacc.c.  */
#line 99 "exprinterpret.tab.c"
...
{
      12,     0,    -1,    13,    -1,     4,    -1,     3,    -1,    13,
       7,    13,    -1,    13,     8,    13,    -1,    13,     5,    13,
      -1,    13,     6,    13,    -1,     9,    13,    10,    -1
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 27 "exprinterpret.y"
    { printf("answer is %i\n", yyvsp[0].intconst); ;}
    break;

  case 3:
#line 29 "exprinterpret.y"
    { yyval.intconst = 1; ;}
    break;

  case 4:
#line 30 "exprinterpret.y"
    { yyval.intconst = yyvsp[0].intconst; ;}
    break;

  case 5:
#line 31 "exprinterpret.y"
    { yyval.intconst = yyvsp[-2].intconst * yyvsp[0].intconst; ;}
    break;

  case 6:
#line 32 "exprinterpret.y"
    { yyval.intconst = yyvsp[-2].intconst / yyvsp[0].intconst; ;}
    break;

  case 7:
#line 33 "exprinterpret.y"
    { yyval.intconst = yyvsp[-2].intconst + yyvsp[0].intconst; ;}
    break;

  case 8:
#line 34 "exprinterpret.y"
    { yyval.intconst = yyvsp[-2].intconst - yyvsp[0].intconst; ;}
    break;

  case 9:
#line 35 "exprinterpret.y"
